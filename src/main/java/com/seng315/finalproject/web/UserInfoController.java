...
import com.seng315.finalproject.domain.userinfo.UserInfo;
...
public class UserInfoController {
    ...
    public Iterable<UserInfo> getAllUserInfo() {
        ...
        logger.info("User " + AccountUtil.getUsername() + " used getAllUsersInfo().") ;
    ...
    public Optional<UserInfo> getUserInfo(@PathVariable int id) {
        ...
        logger.info("User " + AccountUtil.getUsername() + " used getUserInfo().") ;
    ...
    public String updateUserInfo(@RequestBody Map<String,String> formData) {
        ...
        if(userInfoOptional.isPresent()) {
            ...
            logger.info("User " + AccountUtil.getUsername() + " updated UserInfoID " + userInfo.getUserInfoID() + ".");
    ...
    public String addUserInfo(@RequestBody Map<String,String> formData) {
        ...
        userInfo.setPhoneNumber(formData.get("phoneNumber"));
        userInfoRepository.save(userInfo);
        logger.info("User " + AccountUtil.getUsername() + " added users info to db. ");
